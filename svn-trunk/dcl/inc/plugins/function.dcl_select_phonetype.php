...
function smarty_function_dcl_select_phonetype($params, &$smarty)
{
	if (!isset($params['name']))
		$params['name'] = 'phone_type_id';
	...
	$sSQL = 'SELECT phone_type_id, phone_type_name FROM dcl_phone_type ORDER BY phone_type_name';
