<?php
	define('STR_CFG_TITLE', "Inställningar");
	define('STR_CFG_DESC', "Denna sida används för att konfigurera inställningar och beteenden i systemet.");
	define('STR_CFG_SYSTEMTITLE', "Systeminställningar");
	define('STR_CFG_DATEFORMAT', "Format för datumvisning");
	...
	define('STR_CFG_TIMESTAMPFORMAT', "Format för visning av tid.");
	...
	define('STR_CFG_MAXUPLOADFILESIZE', "Maximal storlek för uppladdad fil");
	...
	define('STR_CFG_LANGUAGE', "Standardspråk");
	...
	define('STR_CFG_GDTYPE', "Grafikformat för grafer");
	...
	define('STR_CFG_DEFAULTSTATUSASSIGN', "Förvalt status för tilldelade arbetsorder");
	define('STR_CFG_DEFAULTSTATUSASSIGNHELP', "The default status for new work orders.");
	define('STR_CFG_DEFAULTSTATUSUNASSIGN', "Förvalt status för icke tilldelade arbetsorder");
	...
	define('STR_CFG_DEFAULTPRIORITY', "Förvald prioritet för icke tilldelade arbetsorder");
	define('STR_CFG_DEFAULTPRIORITYHELP', "The default priority for new unassigned work orders.");
	define('STR_CFG_DEFAULTSEVERITY', "Förvald kategori för icke tilldelade arbetsorder");
	define('STR_CFG_DEFAULTSEVERITYHELP', "The default severity for new unassigned work orders.");
	define('STR_CFG_AUTODATE', "Fyll alltid i start- och stoppdatum med nästa dag");
	define('STR_CFG_AUTODATEHELP', "This option will autofill the start date and deadline with tomorrow\'s date.");
	define('STR_CFG_TIMECARDORDER', "Visa arbetsordern för tidrapporten");
	...
	define('STR_CFG_DCLPROJECTXMLTEMPLATES', "Använd XML-mallar (Kräver XML-support i php)");
	...
	define('STR_CFG_TICKETTITLE', "Begäran");
	define('STR_CFG_CQQPERCENT', "Procentuell sannolikhet att skicka kvalitetsfrågeformulär");
	...
	define('STR_CFG_CQQFROM', "Avsändaradress för kvalitetsfrågeformulär");
	define('STR_CFG_CQQFROMHELP', "The e-mail address the quality questionnaire originates from.");
	define('STR_CFG_CQQSUBJECT', "Rubrik för kvalitetsfrågeformulär");
	define('STR_CFG_CQQSUBJECTHELP', "The e-mail subject line for the quality questionnaire.");
	define('STR_CFG_CQQTEMPLATE', "Mall för kvalitetsfrågeformulär");
