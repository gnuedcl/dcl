<?php
	define('STR_PROD_SELECTONE', "Seleccione uno");
	define('STR_PROD_TABLETITLE', "Productos - Ordenados por %s");
	define('STR_PROD_NOPRODS', "No se pudo encontrar Productos para mostrar! Usted, todavia no debe tener ningun producto en su sistema!");
	define('STR_PROD_ID', "ID");
	define('STR_PROD_ACTIVEABB', "A");
	define('STR_PROD_ACTIVE', "Activo");
	define('STR_PROD_SHORT', "Short");
	define('STR_PROD_NAME', "Nombre");
	define('STR_PROD_REPORTTO', "Informar a ");
	...
	define('STR_PROD_WODETAIL', "Detalles de Work Orders");
	define('STR_PROD_TICKETDETAIL', "Detalles de Tickets");
	define('STR_PROD_VIEWWO', "Ver Work Orders");
	define('STR_PROD_VIEWTICKETS', "Ver Tickets");
	define('STR_PROD_NOWORKORDERS', "No work orders in DCL.");
	define('STR_PROD_NOTICKETS', "No tickets in DCL.");
	define('STR_PROD_PREEXISTING', "Pre-existentes");
	define('STR_PROD_CREATED', "Creado");
	define('STR_PROD_CLOSED', "Cerrado");
	define('STR_PROD_OUTSTANDING', "Destacado");
