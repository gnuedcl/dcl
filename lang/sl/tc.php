<?php
	...
	define('STR_TC_EDIT', "Popraveg ร?ยจasovne kartice");
	...
	define('STR_TC_BY', "Od");
	define('STR_TC_ETC', "ร?ยฉe_ur");
	define('STR_TC_BTNADD', "Dodaj");
	define('STR_TC_BTNMOD', "Spremeni");
	define('STR_TC_BTNCLR', "Oร?ยจisti");
	define('STR_TC_HIGHLIGHTEDNOTE', "** Osvetljena polja so obvezna!");
	define('STR_TC_MODIFYNOTE', "OPOMBA: ร?ห?a se pojavi ร?ยจasovna kartica pod to, status in \\\"ร?ยนe ur\\\" ne bo spremenjen.");
	define('STR_TC_MODIFY', "Spremeni");
	define('STR_TC_DELETE', "Zbriร?ยนi");
