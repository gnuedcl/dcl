<?php
	...
	define('STR_TC_BTNCLR', "Rafraîchir");
	define('STR_TC_HIGHLIGHTEDNOTE', "** Les champs en surbrillance sont obligatoires!");
	define('STR_TC_MODIFYNOTE', "NOTE: Si une fiche d\'appel apparait sous celle-ci, le statut et les heures restantes ne seront pas changés.");
	define('STR_TC_MODIFY', "Modifier");
	define('STR_TC_DELETE', "Effacer");
	define('STR_TC_BATCHUPDATE', "Mise à jour Batch");
?>