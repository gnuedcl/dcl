<?php
	...
	define('STR_CFG_DESC', "Cet écran vous permettra de configurer les différents réglages et le fonctionnement par défaut de DCL.");
	define('STR_CFG_SYSTEMTITLE', "Configuration Système");
	...
	define('STR_CFG_TIMESTAMPFORMAT', "Format d\'affichage Date/Heure");
	...
	define('STR_CFG_MAXUPLOADFILESIZEHELP', "Maximum file size allowed for uploading attachments.  0 pour désactiver.  This value only takes effect up to the limit specified in php.ini.");
	define('STR_CFG_LANGUAGE', "Langage par défaut");
	define('STR_CFG_LANGUAGEHELP', "The language that is used by default for users and the login page.");
	define('STR_CFG_PRIVATEKEY', "Clé privée");
	...
	define('STR_CFG_GDTYPE', "Format Graphique pour les Graphiques");
	...
	define('STR_CFG_DEFAULTSTATUSASSIGN', "Statut par défaut pour les Ordres de Travail assignés");
	define('STR_CFG_DEFAULTSTATUSASSIGNHELP', "The default status for new work orders.");
	define('STR_CFG_DEFAULTSTATUSUNASSIGN', "Statut par défaut pour les Ordres de Travail non assignés");
	...
	define('STR_CFG_DEFAULTPRIORITY', "Priorité par défaut pour les Ordres de Travail non assigné");
	define('STR_CFG_DEFAULTPRIORITYHELP', "The default priority for new unassigned work orders.");
	define('STR_CFG_DEFAULTSEVERITY', "Sévérité par défaut pour les Ordres de Travail non assignés");
	define('STR_CFG_DEFAULTSEVERITYHELP', "The default severity for new unassigned work orders.");
	define('STR_CFG_AUTODATE', "Auto-remplissage de la date de départ/Deadline avec la date du prochain jour");
	...
	define('STR_CFG_DCLPROJECTXMLTEMPLATES', "Utiliser les modèles XML (Nécéssite l\'utilisation du support XML)");
	...
	define('STR_CFG_CQQPERCENT', "Probabilité d\'envoyer un questionnaire qualité");
	...
	define('STR_CFG_CQQFROM', "Adresse E-mail de l\'expéditeur du questionnaire qualité");
	define('STR_CFG_CQQFROMHELP', "The e-mail address the quality questionnaire originates from.");
	define('STR_CFG_CQQSUBJECT', "Sujet E-mail pour le questionnaire qualité");
	define('STR_CFG_CQQSUBJECTHELP', "The e-mail subject line for the quality questionnaire.");
	define('STR_CFG_CQQTEMPLATE', "Modèle E-mail pour le questionnaire qualité");
