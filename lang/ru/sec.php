<?php
	...
	define('STR_SEC_GENERATEREPORTFOR', "Генерировать отчет для");
	define('STR_SEC_DATERANGE', "Диапазон дат");
	define('STR_SEC_BEGIN', "Начало");
	define('STR_SEC_ENDING', "Завершение");
	define('STR_SEC_DATEERR', "Не могу печатать отчет без начально и конечной даты.");
