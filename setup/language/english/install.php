<?php
/*
 * $Id: install.php,v 1.1.1.1 2006/11/27 05:31:01 mdean Exp $
 *
 ...
 */
define("_INSTALL_L0","Welcome to the Install Wizard for Double Choco Latte");
define("_INSTALL_L70","Please change the file permission for config.php so that it is writeable by the server (i.e. chmod 777 config.php on a UNIX/LINUX server, or check the properties of the file and make sure the read-only flag is not set on a Windows server ). Reload this page once you have changed the permission setting.");
//define("_INSTALL_L71","Click on the button below to begin the installation.");
define("_INSTALL_L1","Open config.php with your text editor and find the following codes on line 31:");
...
define("_INSTALL_L6","There is a mismatch between your dcl_root configuration on line 31 of config.php and the root path info we have detected.");
...
define("_INSTALL_L11","The server path to your DCL root directory: ");
define("_INSTALL_L12","URL to your DCL root directory: ");
define("_INSTALL_L13","If the above setting is correct, press the button below to continue.");
define("_INSTALL_L14","Next");
define("_INSTALL_L15","Please open config.php and enter required DB settings data");
...
define("_INSTALL_L19","%s is the name of your database in which DCL tables will be created.");
...
define("_INSTALL_L25","We have detected the following database information from your configuration in config.php. Please fix it now if this is not correct.");
...
define("_INSTALL_L63","This prefix will be added to all new tables created to avoid name conflict in the database. If you are unsure, just use the default 'dcl'.");
define("_INSTALL_L54","Use persistent connection?");
define("_INSTALL_L69","Default is 'NO'. Choose 'NO' if you are unsure.");
define("_INSTALL_L55","DCL Physical Path");
define("_INSTALL_L59","Physical path to your main DCL directory INCLUDING trailing slash");
define("_INSTALL_L56","DCL Virtual Path (URL)");
define("_INSTALL_L58","Virtual path to your main DCL directory INCLUDING trailing slash");
...
define("_INSTALL_L60","Could not write into config.php. Please check the file permission and try again.");
define("_INSTALL_L61","Could not write to config.php. Contact the server administrator for details.");
define("_INSTALL_L62","Configuration data has been saved successfully to config.php.");
...
define("_INSTALL_L95","Could not detect the physical path to your DCL directory.");
...
define("_INSTALL_L121","Configuration setting %s set to %s.");
...
define("_INSTALL_L130","The installer has detected your database is an older version.<br />The installer will now attempt to upgrade your DCL database.");
define("_INSTALL_L131","Your database is up to date.");
...
define("_INSTALL_L141","The installer will now update each module to work with DCL.<br />Make sure that you have uploaded all files in DCL package to your server.<br />This may take a while to complete.");
