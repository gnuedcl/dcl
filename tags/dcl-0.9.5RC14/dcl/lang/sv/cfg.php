<?php
	define('STR_CFG_TITLE', "InstÃ?Â¤llningar");
	define('STR_CFG_DESC', "Denna sida anvÃ?Â¤nds fÃ?Â¶r att konfigurera instÃ?Â¤llningar och beteenden i systemet.");
	define('STR_CFG_SYSTEMTITLE', "SysteminstÃ?Â¤llningar");
	define('STR_CFG_DATEFORMAT', "Format fÃ?Â¶r datumvisning");
	define('STR_CFG_DATEFORMATHELP', "The format to use for displaying dates.");
	define('STR_CFG_DATEFORMATDB', "SQL-serverns datumformat");
	define('STR_CFG_DATEFORMATDBHELP', "The format the database uses for storing dates.");
	define('STR_CFG_TIMESTAMPFORMAT', "Format fÃ?Â¶r visning av tid.");
	define('STR_CFG_TIMESTAMPFORMATHELP', "The format to use for displaying timestamps.");
	define('STR_CFG_TIMESTAMPFORMATDB', "SQL-serverns tidsformat");
	define('STR_CFG_TIMESTAMPFORMATDBHELP', "The format the database uses for storing timestamps.");
	define('STR_CFG_MAXUPLOADFILESIZE', "Maximal storlek fÃ?Â¶r uppladdad fil");
	define('STR_CFG_MAXUPLOADFILESIZEHELP', "Maximum file size allowed for uploading attachments.  ignorerar om noll \"0\".  This value only takes effect up to the limit specified in php.ini.");
	define('STR_CFG_LANGUAGE', "StandardsprÃ?Â¥k");
	define('STR_CFG_LANGUAGEHELP', "The language that is used by default for users and the login page.");
	define('STR_CFG_PRIVATEKEY', "Privat nyckel");
	define('STR_CFG_PRIVATEKEYHELP', "This key is appended to any values to be MD5 hashed.");
	define('STR_CFG_ROOT', "DCL:ens adress");
	define('STR_CFG_ROOTHELP', "This is the root URL of DCL for this installation. (Example: http://www.mydomain.com/dcl/)");
	define('STR_CFG_GDTYPE', "Grafikformat fÃ?Â¶r grafer");
	define('STR_CFG_GDTYPEHELP', "The graphics format to use when generating graphs in DCL.");
	define('STR_CFG_LOOKNFEELTITLE', "Utseende");
	define('STR_CFG_DEFTEMPLATESET', "Standardmallar");
	define('STR_CFG_WORKORDERTITLE', "Arbetsorder");
	define('STR_CFG_DEFAULTSTATUSASSIGN', "FÃ?Â¶rvalt status fÃ?Â¶r tilldelade arbetsorder");
	define('STR_CFG_DEFAULTSTATUSASSIGNHELP', "The default status for new work orders.");
	define('STR_CFG_DEFAULTSTATUSUNASSIGN', "FÃ?Â¶rvalt status fÃ?Â¶r icke tilldelade arbetsorder");
	...
	define('STR_CFG_DEFAULTPRIORITY', "FÃ?Â¶rvald prioritet fÃ?Â¶r icke tilldelade arbetsorder");
	define('STR_CFG_DEFAULTPRIORITYHELP', "The default priority for new unassigned work orders.");
	define('STR_CFG_DEFAULTSEVERITY', "FÃ?Â¶rvald kategori fÃ?Â¶r icke tilldelade arbetsorder");
	define('STR_CFG_DEFAULTSEVERITYHELP', "The default severity for new unassigned work orders.");
	define('STR_CFG_AUTODATE', "Fyll alltid i start- och stoppdatum med nÃ?Â¤sta dag");
	define('STR_CFG_AUTODATEHELP', "This option will autofill the start date and deadline with tomorrow\'s date.");
	define('STR_CFG_TIMECARDORDER', "Visa arbetsordern fÃ?Â¶r tidrapporten");
	...
	define('STR_CFG_PROJECTTITLE', "Projekt");
	define('STR_CFG_DCLPROJECTXMLTEMPLATES', "AnvÃ?Â¤nd XML-mallar (KrÃ?Â¤ver XML-support i php)");
	...
	define('STR_CFG_TICKETTITLE', "BegÃ?Â¤ran");
	define('STR_CFG_CQQPERCENT', "Procentuell sannolikhet att skicka kvalitetsfrÃ?Â¥geformulÃ?Â¤r");
	...
	define('STR_CFG_CQQFROM', "AvsÃ?Â¤ndaradress fÃ?Â¶r kvalitetsfrÃ?Â¥geformulÃ?Â¤r");
	define('STR_CFG_CQQFROMHELP', "The e-mail address the quality questionnaire originates from.");
	define('STR_CFG_CQQSUBJECT', "Rubrik fÃ?Â¶r kvalitetsfrÃ?Â¥geformulÃ?Â¤r");
	define('STR_CFG_CQQSUBJECTHELP', "The e-mail subject line for the quality questionnaire.");
	define('STR_CFG_CQQTEMPLATE', "Mall fÃ?Â¶r kvalitetsfrÃ?Â¥geformulÃ?Â¤r");
