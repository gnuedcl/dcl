...
?>
<H3>Beställningar</H3>
Du använder denna sida för nya beställningar. Hjälpen talar om för dig hur du ska fylla i sidan.
<BR>
<BR>
<H4>Ansvarig</H4>
...
the meantime, it is safe to set this field to 'Internal' for tickets
raised internally and 'External' for tickets reported by external
groups.
