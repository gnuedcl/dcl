...
<?php
		...
		{
?>
Cliquez sur <A HREF="mailto:mdean@users.sourceforge.net">ici</A> si vous avez besoin de plus d'aide ou si vous désirez reporter une erreur dans la documentation.
<?php
		}
	}
