...
<BR>
<H4>Product</H4>
Select the product this work order is to be associated with.

<H4>Account</H4>
Select the account (if any) that is specific to this work order.

<H4>Responsible **</H4>
Select the person responsible to complete the work order.
...
<H4>Severity **</H4>
The severity of the work order.

<H4>Contact</H4>
If there is an individual who may be contacted for more
information regarding this work order, put their name/organisation here.
