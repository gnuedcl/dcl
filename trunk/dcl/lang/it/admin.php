<?php
	...
	define('STR_ADMIN_STATUSES', "Statuses");
	...
	define('STR_ADMIN_DEPARTMENTS', "Users");
	define('STR_ADMIN_DEPARTMENTSDESC', "Setup user accounts here to give individuals access to DCL.");
	...
	define('STR_ADMIN_ATTRIBUTESETS', "Products");
	define('STR_ADMIN_ATTRIBUTESETSDESC', "Products is the list of items that you are tracking in DCL.  A product usually indicates a particular software package, but can be used for almost anything (even non-computer related items).");
