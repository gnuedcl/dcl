<!-- $Id: htmlFaqtopicsForm.tpl,v 1.3 2006/11/27 06:00:51 mdean Exp $ -->
{dcl_validator_init}
...
<form class="styled" name="FAQFORM" method="post" action="{$URL_MAIN_PHP}">
	...
	<fieldset>
		<div class="submit">
			...
			<input type="button" value="{$smarty.const.STR_CMMN_CANCEL}" onclick="location.href='{$URL_MAIN_PHP}?menuAction=boFaq.view&faqid={$VAL_FAQID}';">
		</div>
	</fieldset>
</form>