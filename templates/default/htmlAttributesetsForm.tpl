<!-- $Id: htmlAttributesetsForm.tpl,v 1.3 2006/11/27 06:00:51 mdean Exp $ -->
{dcl_validator_init}
...
<form class="styled" method="post" action="{$URL_MAIN_PHP}">
	...
	<fieldset>
		...
		<div class="required">
			<label for="short">{$smarty.const.STR_ATTR_SHORT}:</label>
	...
	<fieldset>
		<div class="submit">
			...
			<input type="button" onclick="location.href = '{$URL_MAIN_PHP}?menuAction=boAttributesets.showall';" value="{$smarty.const.STR_CMMN_CANCEL}">
		</div>
	</fieldset>
</form>