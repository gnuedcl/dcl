<!-- $Id: htmlStatusesForm.tpl,v 1.5 2006/11/27 06:00:52 mdean Exp $ -->
{dcl_validator_init}
...
<form class="styled" method="post" action="{$URL_MAIN_PHP}">
	...
	<fieldset>
		<div class="submit">
			...
			<input type="button" onclick="location.href = '{$URL_MAIN_PHP}?menuAction=boStatuses.showall';" value="{$smarty.const.STR_CMMN_CANCEL}">
		</div>
	</fieldset>
</form>