<!-- $Id: htmlFaqanswersForm.tpl,v 1.3 2006/11/27 06:00:51 mdean Exp $ -->
{dcl_validator_init}
...
<form class="styled" name="FAQFORM" method="post" action="{$URL_MAIN_PHP}">
	<input type="hidden" name="menuAction" value="{if $IS_EDIT}boFaqanswers.dbmodify{else}boFaqanswers.dbadd{/if}">
	...
	<fieldset>
		<div class="submit">
			...
			<input type="button" value="{$smarty.const.STR_CMMN_CANCEL}" onclick="location.href='{$URL_MAIN_PHP}?menuAction=boFaqquestions.view&questionid={$VAL_QUESTIONID}';">
		</div>
	</fieldset>
</form>