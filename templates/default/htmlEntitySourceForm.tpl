<!-- $Id: htmlEntitySourceForm.tpl,v 1.1.1.1 2006/11/27 05:30:37 mdean Exp $ -->
{dcl_validator_init}
...
<form class="styled" method="post" action="{$URL_MAIN_PHP}">
	...
	<fieldset>
		<div class="submit">
			...
			<input type="button" onclick="location.href = '{$URL_MAIN_PHP}?menuAction=htmlEntitySource.ShowAll';" value="{$smarty.const.STR_CMMN_CANCEL}">
		</div>
	</fieldset>
</form>
<script language="JavaScript">
