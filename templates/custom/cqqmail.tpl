...
following questions about your support experience.

1= Very Unsatisfactory, 2= Unsatisfactory, 3= Satisfied, 4= Very Satisfied, 5= Excellent

Using the above scale please rate the following.
*	Was the agent courteous?
*	How would you rate the agent's technical ability?
*	Was your issue resolved?
*	Time to answer?
*	Overall opinion of customer support?
