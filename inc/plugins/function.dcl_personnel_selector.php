<?php
/*
 * $Id: function.dcl_personnel_selector.php,v 1.1.1.1 2006/11/27 05:30:52 mdean Exp $
 *
...
function smarty_function_dcl_personnel_selector($params, &$smarty)
{
...
<?php
	if ($params['decoded'] != '')
	{
		echo $sArrayName . '[0] = "' . $params['decoded'] . '";' . "\n";
	}
?>
...
<a id="<?php echo $params['id']; ?>Link" href="javascript:;" onclick="showSelector(document.getElementById('<?php echo $params['id']; ?>'), <?php echo $sArrayName; ?>, render_<?php echo $sArrayName; ?>, 'htmlPersonnelSelector', 'false');"><?php echo $params['decoded'] == '' ? STR_CMMN_SELECTONE : $params['decoded']; ?></a>
