<?php
/*
 * $Id: function.dcl_select_severity.php,v 1.1.1.1 2006/11/27 05:30:52 mdean Exp $
 *
...
function smarty_function_dcl_select_severity($params, &$smarty)
{
	if (!isset($params['name']))
		$params['name'] = 'severity';
	...
	$sSQL = 'SELECT a.id, a.name FROM severities a';
	if ($params['setid'] > 0)
	{
		$sSQL .= ',attributesetsmap b WHERE a.id=b.keyid AND b.typeid=3 AND b.setid = ' . $params['setid'];
