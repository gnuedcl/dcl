<?php
/*
 * $Id: class.htmlOrgUrl.inc.php,v 1.1.1.1 2006/11/27 05:30:50 mdean Exp $
 *
...
class htmlOrgUrl
{
	...
	function submitAdd()
	{
		...
		$oOrgPhone =& CreateObject('dcl.boOrgUrl');
		$oOrgPhone->add(array(
						'org_id' => $id,
