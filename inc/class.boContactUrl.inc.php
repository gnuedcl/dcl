<?php
/*
 * $Id: class.boContactUrl.inc.php,v 1.1.1.1 2006/11/27 05:30:45 mdean Exp $
 *
...
class boContactUrl extends boAdminObject
{
	function boContactUrl()
	{
		parent::boAdminObject();

		$this->oDB =& CreateObject('dcl.dbContactUrl');
