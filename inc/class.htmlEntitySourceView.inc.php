<?php
/*
 * $Id: class.htmlEntitySourceView.inc.php,v 1.1.1.1 2006/11/27 05:30:42 mdean Exp $
 *
...
import('htmlView');
class htmlEntitySourceView extends htmlView
{
	function htmlEntitySourceView()
	{
		parent::htmlView();
		$this->sColumnTitle = STR_CMMN_OPTIONS;
		$this->sSortAction = 'htmlEntitySourceView.execurl';
	}
	...
	function _SetActionFormOptions()
	{
		...
		if ($g_oSec->HasPerm(DCL_ENTITY_SOURCE, DCL_PERM_ADD))
			$aLinks[STR_CMMN_NEW] = menuLink('', 'menuAction=htmlEntitySource.add');
