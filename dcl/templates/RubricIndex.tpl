...
{block name=title}Rubrics{/block}
{block name=css}
...
<script type="text/javascript">
	...
	function formatOptions(value, options, row) {
		...
		{if $PERM_EDIT}retVal.push('<a class="btn btn-xs btn-primary" href="{dcl_url_action controller=Rubric action=Edit params="id="}' + row[0] + '" title="{$smarty.const.STR_CMMN_EDIT|escape}"><span class="glyphicon glyphicon-pencil"></span></a>');{/if}
