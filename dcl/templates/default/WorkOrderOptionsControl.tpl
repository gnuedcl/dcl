...
{/if}
{if $PERM_ADDTASK}<li {if $ctlWorkOrderOptions_isfirst == "true"}{assign var="ctlWorkOrderOptions_isfirst" value="false"}class="first"{/if}><a href="{$URL_MAIN_PHP}?menuAction=Project.AddTask&jcn={$VAL_JCN}&seq={$VAL_SEQ}">Project</a></li>{/if}
...
{if $PERM_REMOVETASK}<li {if $ctlWorkOrderOptions_isfirst == "true"}{assign var="ctlWorkOrderOptions_isfirst" value="false"}class="first"{/if}><a href="{$URL_MAIN_PHP}?menuAction=Project.RemoveTask&jcn={$VAL_JCN}&seq={$VAL_SEQ}">Remove from Project</a></li>{/if}
