<html>
	<head>
		<frameset rows="85,*" border="0" frameborder="0">
			...
			<frame name="mainFrame" src="{$smarty.const.DCL_WWW_ROOT}main.php?menuAction=htmlProjectSelector.showBrowseFrame&multiple={$VAL_MULTIPLE}&filterID={$VAL_FILTERID}" marginwidth="0" marginheight="0" scrolling="auto">
		</frameset>
	</head>
</html>