...
<div class="container">
	<div class="row top12">
		<div class="col-lg-6"><img src="{$URL_MAIN_PHP}?menuAction=ProductImage.TicketStatusChart&id={$VAL_ID}"></div>
		<div class="col-lg-6"><img src="{$URL_MAIN_PHP}?menuAction=ProductImage.TicketModuleChart&id={$VAL_ID}"></div>
	</div>
	<div class="row top12">
		<div class="col-lg-6"><img src="{$URL_MAIN_PHP}?menuAction=ProductImage.TicketTypeChart&id={$VAL_ID}"></div>
		<div class="col-lg-6"><img src="{$URL_MAIN_PHP}?menuAction=ProductImage.TicketPriorityChart&id={$VAL_ID}"></div>
	</div>
</div>
{/block}