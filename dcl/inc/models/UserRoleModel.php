...
class UserRoleModel extends dclDB
{
	...
	public function ListPermissions($personnel_id, $entity_type_id, $entity_id1 = 0, $entity_id2 = 0, $aPermissions = '')
	{
		...
		{
			$sSQL .= ' AND rp.perm_id IN (' . join(',', $aPermissions) . ')';
		}

		return $this->Query($sSQL);
	}

	public function &GetGlobalRoles($personnel_id = -1)
	{
	...
	public function DeleteGlobalRolesNotIn($personnel_id, $sRoleList = '')
	{
		if ($sRoleList == '')
			$sRoleList = '-1';
	...
	public function HasSpecificRole($personnel_id, $role_id)
	{
