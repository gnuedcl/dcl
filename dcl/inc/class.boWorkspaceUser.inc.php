...
class boWorkspaceUser extends boAdminObject
{
	function boWorkspaceUser()
	{
		parent::boAdminObject();
		
		$this->oDB =& CreateObject('dcl.dbWorkspaceUser');
	...
	{
		trigger_error('boWorkspaceUser::modify unsupported');
	}
	
	function delete(&$aSource)
	{
		trigger_error('boWorkspaceUser::delete unsupported');
	}
