...
class SecurityHelper
{
	...
	function HasPerm($entity, $perm, $id1 = 0, $id2 = 0)
	{
		...
		{
			if (!in_array($entity, array(DCL_ENTITY_WORKORDER, DCL_ENTITY_TIMECARD, DCL_ENTITY_TICKET, DCL_ENTITY_RESOLUTION, DCL_ENTITY_FAQ, DCL_ENTITY_PRODUCT, DCL_ENTITY_PREFS, DCL_ENTITY_ORG)))
			{
				return false;
			}
		}
