...
class imgOrganization
{
	var $img;
	var $aAddlColors;
	var $iMaxSliceIndex;

	function imgOrganization()
	{
	...
	function byOrganization()
	{
		...
		$this->pie($oDB, 'Work Orders By Organization');
	}

	function byOrganizationTickets()
	{
		global $g_oSec;
		...
		$this->pie($oDB, 'Tickets By Organization');
	}
	...
	function byStatusTicket()
	{
		...
		$this->pie($oDB, 'Tickets By Status');
	}

	function byTypeTicket()
	{
		global $g_oSec;
		...
		$this->pie($oDB, 'Tickets By Type');
	}

	function byPriorityTicket()
	{
		global $g_oSec;
		...
		$this->pie($oDB, 'Tickets By Priority');
	}

	function byModuleTicket()
	{
		global $g_oSec;
